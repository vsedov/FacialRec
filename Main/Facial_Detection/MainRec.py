...
def main():
    ...
    class_weight='balanced', coef0=0.001, decision_function_shape='ovr',
    ...
    embedder = cv2.dnn.readNetFromTorch(
        "/home/viv/GitHub/Facial Recognition/Main/Model/openface_nn4.small2.v1.t7"
    )

    # load the actual face recognition model along with the label encoder
    recognizer = pickle.loads(
        open(
            "/home/viv/GitHub/Facial Recognition/Main/output/recognizer.pickle", "rb"
        ).read()
    )
    le = pickle.loads(
        open("/home/viv/GitHub/Facial Recognition/Main/output/main.pickle", "rb").read()
    )
