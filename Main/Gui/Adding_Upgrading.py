...
sys.path.insert(
    0, '/home/viv/GitHub/Facial Recognition/Main/Facial_Detection/')
...
def UPAD():
    ...
    if imayes.lower() == "yes":  # Accepts both types of input that has Upercase and lower case values
        ...
        if usds.lower() == "yes":
            ...
            var = str(input("are you use that you do not want the listing of the path  ?  \n there is a chance of having the path repeated with new users - Each user is Case Sensitive \n"))
